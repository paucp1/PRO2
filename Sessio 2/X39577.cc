...
M files formades pel DNI de cada estudiant (en el mateix ordre que en l’entrada) seguit de la nota mitjana que ha obtingut en les assignatures Ab1,…,AbS.
...
Només s’ha d’enviar el programa principal en el qual s’inclourà, entre d’altres, la classe Estudiant mitjançant
